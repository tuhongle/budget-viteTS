...
const { oldUser, isNewAccount, isWrongPass, needLogInAgain, isAuth, mail, pass, currentUser, budgetAmount, budgetName, budgets, budgetsNameList, budgetChoose, expenses, expenseAmount, expenseName } = storeToRefs(budgetStore);
        ...
        <div class="row pt-0 pt-md-5 flex-column-reverse flex-md-row">
          <div class="col-12 col-md-6 pt-0 pt-md-5">
            ...
            <form @submit.prevent>
              ...
              <p v-if="isWrongPass" class="small text-danger">Wrong Password.</p>
              <p v-if="needLogInAgain" class="small text-danger">You need to ReAuthen before delete account.</p>
