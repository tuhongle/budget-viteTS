<template>
    ...
    <td v-if="!wantDelete"><RouterLink :to="{ name: 'budget', params: { id: expense.budgetID}}" type="button" class="style btn rounded-pill text-light" :style="{ backgroundColor: expense.budgetColor }">{{ expense.budgetName }}</RouterLink></td>
